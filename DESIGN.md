...
Status: the M10 evaluation and visual system are verified in production at application revision `historical-release`. Future deployments remain separately approval-gated.
...
Before public deployment, the evaluation artifacts, production build, and repository tests must pass. Representative desktop (1440×1000), tablet (834×1112), and mobile (390×844) screenshots must show usable controls, evidence-readiness status, simulated-review placement, legible charts, chart alternatives, and no overflow of essential content. Screenshot approval and deployment approval are separate release decisions.
